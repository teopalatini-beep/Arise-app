...
const MORNING_MESSAGES = [
  ...
  { title: 'Estándar alto', body: 'El vos de hoy es el resultado de lo que el vos de ayer eligió hacer cuando no quería.' },
  { title: 'Intención primero', body: 'Cada mañana que arrancás con intención ya es una victoria. Capitalizala.' },
  ...
  { title: 'Pura disciplina', body: 'Sin talento especial: solo constancia. Mirá en lo que se convierte quien no se rinde.' },
  { title: 'El momento es ahora', body: '"No actúes como si tuvieras diez mil años de vida." — Marco Aurelio. Hoy es el día.' },
  { title: 'Entrená igual', body: 'Nadie llegó lejos esperando inspiración. La disciplina llega antes que las ganas.' },
  ...
  { title: 'Arise', body: 'La disciplina es el puente entre las metas y los logros. Hoy cruzás ese puente.' },
  { title: 'Primer movimiento', body: 'El secreto no es motivación. Es hacer el primer movimiento aunque cueste. Hacelo.' },
  { title: 'Más fuerte después', body: 'Cada derrota bien procesada te deja más capaz. Hoy es un nuevo ciclo. Usalo.' },
  { title: 'Lo que te define', body: 'Lo que hacés cuando no tenés ganas — ahí es exactamente donde se construye el carácter.' },
  // Estoicismo
  ...
  { title: 'Haz lo que toca', body: 'No busques que el día sea perfecto. Solo hacé lo que la naturaleza requiere ahora mismo. — Marco Aurelio' },
  ...
  { title: 'Nunca bajés los brazos', body: 'Te van a subestimar una y otra vez. Seguí entrenando. Eso te lleva más allá de cualquier límite.' },
];
...
const AFTERNOON_MESSAGES = [
  ...
  { title: 'Foco total', body: 'Enfocate. Una misión a la vez. No necesitás perfección — necesitás que se haga.' },
  { title: 'El único entreno malo', body: '"El único entrenamiento malo es el que no se hizo." Todavía estás a tiempo de hacerlo.' },
  { title: 'Los campeones no paran', body: 'Los campeones no tienen solo buenas mañanas. Tienen buenos hábitos de tarde también.' },
  { title: 'Terminá lo que empezaste', body: 'Empezar es fácil. Terminar separa a quien construye del resto. Terminá tu día fuerte.' },
  ...
  { title: 'Fuerza mental', body: 'Los que llegan no son siempre los más talentosos — son los que aguantaron cuando los demás se rindieron.' },
  { title: 'Ventana abierta', body: 'Hay una ventana de tiempo antes de que cierre el día. Todavía estás dentro. Aprovechala.' },
  { title: 'Sin quejas', body: 'El orgullo de quien se respeta no espera a que pase el cansancio. Ejecutá igual.' },
  { title: 'Sin negociación', body: 'Tu yo futuro no negocia excusas. Solo ve resultados. Dale algo de qué estar orgulloso.' },
  { title: 'El esfuerzo acumula', body: 'Cada acción de hoy se suma en silencio. En 30 días lo vas a ver clarísimo.' },
  // Estoicismo
  ...
  { title: 'Baja el ruido', body: 'El cerebro de la tarde fabrica urgencias falsas. Cerrá las distracciones. Abrí la app. Completá lo que queda.' },
  { title: 'Sin excusas', body: 'Quien opera al máximo no necesita justificación. Vos tampoco. Terminá el día limpio.' },
];
...
const NIGHT_MESSAGES = [
  ...
  { title: 'Descansá bien', body: 'Respirá. El que dio todo hoy merece descansar sin culpa. Abrí el diario y soltá el día.' },
  ...
  { title: 'Nunca parás', body: 'No era el más talentoso. Era el que nunca se detenía. Vos tampoco. Eso lo cambia todo.' },
  ...
  { title: 'La oscuridad enseña', body: 'El miedo mal gestionado te arrastra. Lo que enfrentaste hoy sin rendirte cortó ese ciclo.' },
  // Mis agregados noche
  ...
  { title: 'El descanso es parte', body: 'El descanso no es recompensa del perezoso — es la recarga de quien construye. Dormí bien. Mañana arrancás.' },
...
const STREAK_REMINDER_MESSAGES = [
  ...
  { title: 'No falles dos veces', body: 'Hoy todavía podés cumplir. La racha vale más de lo que cuesta hacer las misiones ahora.' },
...
const MILESTONE_MESSAGES: Record<number, { title: string; body: string }> = {
  30: {
    title: 'FASE 1 COMPLETADA — Disciplina confirmada',
    body: '30 días de entrenamiento puro. El 80% no llega aquí. Vos sí. La Fase 2 empieza mañana.',
  },
  60: {
    title: 'FASE 2 COMPLETADA — Consistencia probada',
    body: '60 días. Dos meses construyendo quien sos. Quedan 30 días para cerrar el ciclo. No pares.',
  },
  90: {
    title: 'ARISE COMPLETE — 90 días',
